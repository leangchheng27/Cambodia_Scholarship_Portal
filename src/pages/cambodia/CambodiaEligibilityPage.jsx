  ...
  return (
    <div className="detail-page">
      ...
      <div className="detail-container">
        <ScholarshipSidebar id={id} basePath="/cambodia" activePage="eligibility" />
...
export default CambodiaEligibilityPage;
