 ...
 */
function matchesUniversityField(scholarship, userField) {
 ...
 */
function calculateUniversityMatchScore(scholarship, userField, userGPA = null) {
 ...
 */
function getUniversityInternshipRecommendations(internships, userField, userGPA = null, limit = 10) {
 ...
 */
function generateUniversityMatchReasons(scholarship, userField, matchScore) {
  const reasons = [];
