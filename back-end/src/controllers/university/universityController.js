...
const universityController = {
  ...
  async getById(req, res) {
    try {
      ...
      } catch (e) { university.dataValues.UniversityMajors = []; }
      ...
      } catch (e) { university.dataValues.UniversityApplicationGuideSteps = []; }
      ...
      } catch (e) { university.dataValues.UniversityTuitionFees = []; }
      ...
      } catch (e) { university.dataValues.UniversityStudentAchievements = []; }
